...
import { getEmployeesDefault, getDepartmentObjDefault, getActiveEmployeeDefault } from '@/utils/vuex-module';
...
class Employee extends VuexModule implements IEmployeeState {
    ...
    public async GetEmployeeById(id: number | null = null): Promise<any> {
        try {
            ...
            return {
                employees: this.employees.splice(0, this.employees.length, employee || {}),
            };
        } 
        catch (e) {
            return {
